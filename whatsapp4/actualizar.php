        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            <table border=1>
                ...
                <tr>
                    ...
                    <td><input type="text" name="email" value="<?php echo $fila['whatsapp']?>" require></td>
                </tr>
                <tr>
                    <td><label for="tel">Telefono:</label></td>
                    <td><input type="tel" name="tel" value="<?php echo $fila['whatsapp']?>" require></td>
                </tr>
                <tr>
                    <td><label for="cel">Celular:</label></td>
                    <td><input type="tel" name="cel" value="<?php echo $fila['whatsapp']?>" require></td>
                </tr>
                <tr>
